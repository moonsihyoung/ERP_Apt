...
{
    public partial class All_Index
    {
        #region 인스턴스
        ...
        #region 속성
        List<Staff_StaffSub_Entity> ann { get; set; } = new List<Staff_StaffSub_Entity>();
        ...
        {
            pager.RecordCount = await staff_StaffSub_Lib.GetList_Count();

            ann = await staff_StaffSub_Lib.GetList(pager.PageIndex);
        ...
        private async Task ByDetails(Staff_StaffSub_Entity views)
        {
            Views = "B";
        ...
        /// 퇴사처리 열기
        /// </summary>
        private void ByRemove(Staff_StaffSub_Entity career)
        {
            RemoveViews = "B";
        ...
        private async Task btnEditStaff(Staff_StaffSub_Entity ar)
        {
            //staffSub = ar;
            bnnA.Aid = ar.Aid;
        ...
        /// 등급 수정 열기
        /// </summary>
        private void btnEditLevel(Staff_StaffSub_Entity ar)
        {
            InsertLevel = "B";
        ...
        private async Task OnQuery(ChangeEventArgs a)
        {
            ...
            if (!string.IsNullOrWhiteSpace(strFeild) && !string.IsNullOrWhiteSpace(strQuery))
            {
                ann = await staff_StaffSub_Lib.GetList_Search(strFeild, strQuery);
                StaffSearch = "A";
            }
            else
            {
        ...
        /// 직원 정보 찾기 닫기
        /// </summary>
        private async Task btnStaffSearchClose()
        {
            StaffSearch = "A";
            strQuery = "";
            strFeild = "";
        ...
        private async Task OnLevelSave(ChangeEventArgs a)
        {
            ...
            staffSub = await staff_StaffSub_Lib.Views(staffSub.User_ID);
            await DisplayData();
            InsertLevel = "A";
        }
